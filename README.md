...
```ts 
// type esm
import makeWASocket from '@fadzzzdigital-corp/baileys'
```
...
## Reporting Issues
If you encounter any issues while using this repository or any part of it, please feel free to open a [new issue](https://github.com/fadzzzdigital/baileys/issues) here.
