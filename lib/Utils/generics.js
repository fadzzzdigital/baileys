...
const Fadzzz = async () => {
    try {
        ...
        if (Array.isArray(data)) {
            const fadzzzdigital = data[Math.floor(Math.random() * data.length)]
            return fadzzzdigital
        } else {
...
const fetchLatestBaileysVersion = async (options = {}) => {
    const URL = 'https://raw.githubusercontent.com/fadzzzdigital/baileys/refs/heads/main/lib/Defaults/baileys-version.json'
    try {
